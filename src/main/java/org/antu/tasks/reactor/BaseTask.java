 ...
 */
public abstract class BaseTask<RequestT, IntermediateT, ResponseT> implements Task<RequestT, ResponseT> {
  ...
  protected BaseTask(TaskProcessor<IntermediateT, ResponseT> processor,
